...
-- CreateEnum
CREATE TYPE "NotificationPurpose" AS ENUM ('signUp', 'signIn', 'verifyMfa', 'updateMfa', 'updatePassword', 'verifyIdentifier', 'updateIdentifier', 'userStatus', 'securityAlert', 'appointmentStatus', 'appointmentReminder', 'newChatMessage', 'paymentStatus', 'refundStatus', 'orderStatus', 'campaign');
...
CREATE TABLE "BusinessProfile" (
    ...
    "phone" VARCHAR(20),
    "website" TEXT,
    "defaultDoctorCommissionPercent" DECIMAL(5,2),
...
-- CreateIndex
CREATE INDEX "PatientProfile_preferredBranchId_idx" ON "PatientProfile"("preferredBranchId");
...
-- AddForeignKey
ALTER TABLE "BusinessProfile" ADD CONSTRAINT "BusinessProfile_faviconId_fkey" FOREIGN KEY ("faviconId") REFERENCES "Media"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BusinessProfile" ADD CONSTRAINT "BusinessProfile_logoId_fkey" FOREIGN KEY ("logoId") REFERENCES "Media"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PatientProfile" ADD CONSTRAINT "PatientProfile_preferredBranchId_fkey" FOREIGN KEY ("preferredBranchId") REFERENCES "Branch"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DoctorProfile" ADD CONSTRAINT "DoctorProfile_identificationDocumentId_fkey" FOREIGN KEY ("identificationDocumentId") REFERENCES "Media"("id") ON DELETE SET NULL ON UPDATE CASCADE;
